frappe.pages['app-user-attendance-'].on_page_load = (wrapper) => {
...
class AppUserAttendanceReport {
    ...
    fetch_and_render = () => {
        ...
        `);
        frappe.call('field_force.field_force.page.app_user_attendance_.app_user_attendance_.get_user_attendance_data', {
            filters: {
                from_date: from_date,
                to_date: to_date,
                user: user,
